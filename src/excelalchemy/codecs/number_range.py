...
class NumberRange(CompositeExcelFieldCodec):
    ...
    @classmethod
    def parse_input(cls, value: dict[str, str] | str | Any, field_meta: FieldMetaInfo) -> Any:
    ...
    @classmethod
    def normalize_import_value(cls, value: Any, field_meta: FieldMetaInfo) -> 'NumberRange':
