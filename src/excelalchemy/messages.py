...
class MessageKey(StrEnum):
    ...
    FIELD_DEFINITIONS_MUST_USE_EXCELCOLUMN = 'field_definitions_must_use_excelcolumn'
...
class LocaleFallbackPolicy:
    """Locale fallback policy for runtime and workbook-facing messages."""

    default_locale: str
    supported_locales: tuple[str, ...]
    missing_locale_fallback_locale: str
    missing_key_fallback_locale: str


RUNTIME_LOCALE_POLICY: Final = LocaleFallbackPolicy(
    default_locale='en',
    supported_locales=('en',),
    missing_locale_fallback_locale='en',
    missing_key_fallback_locale='en',
)
...
DEFAULT_LOCALE: Final[str] = RUNTIME_LOCALE_POLICY.default_locale
DISPLAY_DEFAULT_LOCALE: Final[str] = DISPLAY_LOCALE_POLICY.default_locale
SUPPORTED_RUNTIME_LOCALES: Final[tuple[str, ...]] = RUNTIME_LOCALE_POLICY.supported_locales
SUPPORTED_DISPLAY_LOCALES: Final[tuple[str, ...]] = DISPLAY_LOCALE_POLICY.supported_locales
...
MESSAGES: Final[dict[str, dict[MessageKey, str]]] = {
    'en': {
        ...
        MessageKey.FIELD_DEFINITIONS_MUST_USE_EXCELCOLUMN: (
