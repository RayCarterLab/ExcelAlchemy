...
Engineering records: [Plans](harness/plans/README.md) · [Technical Debt](docs/tech-debt/README.md) · [Historical ADRs](docs/history/adr/README.md)
...
The full mapping is in [docs/about.md](docs/about.md); the short version is:
...
Import workflow output excerpt:
...
When you inspect import-run state from the facade, use the explicit 3.0 names:
...
Both containers remain mapping-like for direct inspection, and they also expose
...
See [docs/about.md](docs/about.md) for the migration rationale behind each step.
...
More detail is documented in [docs/about.md](docs/about.md).

## Docs Map

- [README.md](README.md): product + design overview
- [README_cn.md](README_cn.md): Chinese usage-oriented guide
- [docs/about.md](docs/about.md): engineering rationale and evolution notes
